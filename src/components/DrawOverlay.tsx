      ...
      <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
        ...
        <div className="relative z-10 w-full max-w-sm animate-result-in rounded-3xl border border-white/20 bg-gradient-to-b from-slate-900/95 to-black/90 p-8 text-center shadow-2xl">
          ...
          <button
            type="button"
            onClick={onHome}
            className="mt-8 w-full rounded-2xl bg-gradient-to-r from-slate-500 to-slate-600 py-4 text-lg font-bold text-white shadow-lg transition hover:brightness-110"
          >
