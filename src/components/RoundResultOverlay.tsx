...
export function RoundResultOverlay({
  ...
  return (
    <div className="round-overlay round-overlay-result pointer-events-none fixed inset-0 z-40 flex flex-col justify-end">
      <div className="round-overlay-backdrop pointer-events-auto absolute inset-0" />

      <div className="round-result-panel pointer-events-auto relative z-10 mx-3 mb-4 max-h-[48vh] overflow-y-auto rounded-2xl p-4 animate-result-in sm:mx-4 sm:mb-6 sm:p-5">
